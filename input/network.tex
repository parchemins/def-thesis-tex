...
%   Facilite l'accès à un \textbf{grand nombre d'utilisateurs}.
%   % \begin{itemize}
...
% %  \begin{itemize}
% %  \item [$\rightarrow$]
%   Expose au \textbf{pic soudains de popularité}.
%   \end{minipage}
%   \hfill
%   \begin{minipage}{0.28\textwidth}
%     \includegraphics[width=0.8\textwidth]{img/www.png}
%   \end{minipage}
% %  \end{itemize}
...
\begin{frame}{Communication}{État de l'art}
  ...
  \begin{center}
    \includegraphics[width=0.8\textwidth]{img/network/motivation.eps}
  \end{center}
...
\begin{frame}{Communication}{Expérimentations}
  ...
  \item \SPRAY : vue partielle dont la taille s'ajuste au réseau et adapté au
    contexte Web.
  \end{itemize}
