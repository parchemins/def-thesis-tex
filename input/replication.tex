...
\begin{frame}{Structure de séquences}{Ordre dense grâce aux identifiants}
...
\begin{frame}{Structure de séquences}{Représentation sous forme d'arbre}
...
\begin{frame}{Structure de séquences}{État de l'art}
